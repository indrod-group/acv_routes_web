...
import { Advertisement, License, Manual, Vehicle } from "../Entities";
...
export class Convert {
  ...
  public static toLicenses(json: string): License[] {
    return JSON.parse(json) as License[];
  }

  public static licensesToJson(value: License[]): string {
    return JSON.stringify(value);
  }
